        ...
        <div className="profile-page section video-page">
          <div className="form-section container-full ">
            ...
            <div className="seprator-section ">
              <h4>Share to Instagram with the Reveo app</h4>
              <ul>
                <li>
                  <label>STEP 1:</label> Click to download the app below and log in.
                </li>
                <li>
                  <label>STEP 2: </label> Select the video you want to share.
                </li>
                <li>
                  <label>STEP 3: </label>
                  Tap MORE under “Share your video!” to reveal all of the
                  sharing options.
                </li>
                <li>
                  <label>STEP 4: </label> Send your video to Instagram.
                </li>
                <li>
                  <label>STEP 5: </label> Complete your Instagram post.
                </li>
