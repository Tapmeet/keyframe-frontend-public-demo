...
import { apigetVideo, apiPath, apiUploadYoutube } from "../../Utility/Utility";
import moment from "moment";
import { useRouteMatch } from "react-router-dom";
import { CopyToClipboard } from "react-copy-to-clipboard";
import download from "downloadjs";
const YoutubeShare = (props) => {
  ...
  const handleShare = () => {
    axios
      .post(apiUploadYoutube, {
        title: videoTitle,
        filePath: videoUrl,
        description: "Reveo Video",
      })
      .then((response) => {
        console.log(response.data.scopeurl);
        window.open(response.data.scopeurl, '_blank', 'noopener,noreferrer');
      })
      .catch((error) => {
        console.log(error);
      });
        ...
        <div className="profile-page section video-page">
          <div className="form-section container-full ">
            ...
            <div className="seprator-section ">
              <h4>Share to Youtube </h4>
              <ul>
                <li>
                  After you share from REVEO, it can take up to 20 minutes for
                  your video to appear on YouTube. If you don’t have a YouTube
                  account, sign up here.
                </li>

                <li>
                  Current resolution: High Quality (1080P)
                  <br />
                  For best results, upgrade your video to HD.
                </li>
              </ul>
