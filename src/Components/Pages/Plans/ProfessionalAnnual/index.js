...
const ProfessionalAnnual = (props) => {
  ...
  const createOrder = (data, actions) => {
    return actions.subscription
      .create({
        plan_id: "P-8BG365176D338140KMVNCWRQ",
      });
  };
        ...
        <div className="container">
          <div className="row ">
            <div className="col-12 text-center">
              <h2>Reveo Professional- Annual</h2>
              <iframe
                src={`https://app.paykickstart.com/checkout-embed/3ff50bdbf62a50a677c1261a60f41a19ba0a6aed?first_name=${userFirstName}&&last_name=${userLastName}&&email=${userEmail}&&billing_phone_number=${userPhone}`}
                width="100%"
                // scrolling="no"
                frameborder="0"
                style={{ height: "210vh" }}
