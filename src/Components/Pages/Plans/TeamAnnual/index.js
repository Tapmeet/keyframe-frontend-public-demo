        ...
        <div className="container">
          <div className="row ">
            <div className="col-12 text-center">
              <h2>Reveo Team - Annual</h2>
              <iframe
                src={`https://app.paykickstart.com/checkout-embed/afcee3ceb00ca9281cbc663d768186cab3ce3883?first_name=${userFirstName}&&last_name=${userLastName}&&email=${userEmail}&&billing_phone_number=${userPhone}`}
                width="100%"
                // scrolling="no"
                frameborder="0"
                style={{ height: "280vh" }}
