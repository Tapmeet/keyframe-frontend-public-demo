...
import HOC from "./HOC";
const PlayerSceneThirtyThree= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-18 scene-2 scene-33"
              : "playerui-wrapper  slider-section section-18 scene-2 scene-33"
          }
        >
...
export default PlayerSceneThirtyThree;
