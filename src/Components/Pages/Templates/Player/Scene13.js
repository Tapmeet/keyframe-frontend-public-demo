...
import HOC from "./HOC";
const PlayerSceneThirteen = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-13 "
              : "playerui-wrapper  slider-section scene-2 scene-13"
          }
        >
...
export default PlayerSceneThirteen;
