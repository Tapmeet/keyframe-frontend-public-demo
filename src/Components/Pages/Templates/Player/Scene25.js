...
import HOC from "./HOC";
const PlayerSceneTwentyFive = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section   section-five section-six section-25"
              : " playerui-wrapper  slider-section    section-five section-six section-25"
          }
        >
...
export default PlayerSceneTwentyFive;
