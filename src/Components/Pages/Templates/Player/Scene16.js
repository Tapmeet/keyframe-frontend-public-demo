...
import HOC from "./HOC";
const PlayerSceneSixteen = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-16"
              : " playerui-wrapper  slider-section scene-16 "
          }
        >
...
export default PlayerSceneSixteen;
