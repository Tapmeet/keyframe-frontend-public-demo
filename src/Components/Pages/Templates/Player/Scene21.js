...
import HOC from "./HOC";
const PlayerSceneTwentyOne = (props) => {
  console.log(props);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-16 section-18 scene-19 scene-21  "
              : " playerui-wrapper  slider-section scene-2 scene-16 section-18 scene-19  scene-21"
          }
        >
...
export default PlayerSceneTwentyOne;
