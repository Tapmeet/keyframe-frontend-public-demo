...
import HOC from "./HOC";
const PlayerSceneFourtyTwo = (props) => {
  console.log(props);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2  scene-42  section-six scene-34 scene-16 section-18 scene-19  scene-32"
              : " playerui-wrapper  slider-section scene-2  scene-42 section-six scene-34 scene-16 section-18 scene-19  scene-32 "
          }
        >
...
export default PlayerSceneFourtyTwo;
