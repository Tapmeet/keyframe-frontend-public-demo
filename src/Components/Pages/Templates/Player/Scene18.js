...
import HOC from "./HOC";
const PlayerSceneEighteen= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-18 scene-2"
              : "playerui-wrapper  slider-section section-18 scene-2"
          }
        >
...
export default PlayerSceneEighteen;
