    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section  section-five"
              : " playerui-wrapper  slider-section  section-five"
          }
        >
...
export default PlayerSceneFive;
