    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-20 scene-16 scene-17  "
              : " playerui-wrapper  slider-section scene-20 scene-16 scene-17  "
          }
        >
...
export default PlayerSceneTwenty;
