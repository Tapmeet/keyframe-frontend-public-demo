...
import HOC from "./HOC";
const PlayerSceneFourtyFive = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-16 scene-45  scene-24"
              : " playerui-wrapper  slider-section scene-16  scene-45  scene-24"
          }
        >
...
export default PlayerSceneFourtyFive;
