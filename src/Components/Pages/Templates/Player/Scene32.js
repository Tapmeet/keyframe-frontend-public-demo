...
import HOC from "./HOC";
const PlayerSceneThirtyTwo = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2  section-six scene-16 section-18 scene-19  scene-32"
              : " playerui-wrapper  slider-section scene-2 section-six scene-16 section-18 scene-19  scene-32 "
          }
        >
...
export default PlayerSceneThirtyTwo;
