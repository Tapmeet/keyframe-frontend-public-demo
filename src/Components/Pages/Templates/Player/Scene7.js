    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section   section-six section-seven"
              : " playerui-wrapper  slider-section    section-six section-seven"
          }
        >
...
export default PlayerSceneSeven;
