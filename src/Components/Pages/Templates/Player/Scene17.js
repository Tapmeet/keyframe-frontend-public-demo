...
import HOC from "./HOC";
const PlayerSceneSeventeen = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-16 scene-17"
              : " playerui-wrapper  slider-section scene-16 scene-17"
          }
        >
...
export default PlayerSceneSeventeen;
