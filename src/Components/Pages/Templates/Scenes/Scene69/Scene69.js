...
const SceneFourtyTwo = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2  scene-42  up scene-16 section-18 scene-34 scene-19 section-six scene-32 scene-69 slider-section">
      ...
      {/* {textShow && content.length >= 45 ? <div class={content.length >= 65 ? "char-counter  red" : "char-counter "}>  {65 - content.length} </div> : null} */}
    </section>
  );
};
