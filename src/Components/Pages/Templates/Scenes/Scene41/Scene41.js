...
const SceneFourtyOne = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2 scene-16 scene-40 scene-41 section-18 scene-19 slider-section">
       <Loader open={processing} /><div className="d-flex relative">
                          ...
                          <div className="buttonsection_zoom d-flex">
                            ...
                            <div className="scale-edit">
                              <img
                                ...
                                onClick={() => filterBtnClick( mediaArray[0].url, 0)}
                                data-tip=""
                                data-for="edit"
                              />
                              <ReactTooltip
                            ...
                            <div className="scale-ok">
                              <img
                                ...
                                alt="Thumbnail"
                                className="img-fluid trash"
                                onClick={() => showCroppedImage( mediaArray[0].url)}
                                data-tip=""
                                data-for="done"
                              />
                              <ReactTooltip
        ...
        {textShow && content.length >= 72 ? <div class={content.length >= 92 ? "char-counter bottom  red" : "char-counter bottom "}>  {92 - content.length} </div> : null}
        {/* {textShow ? <div class="char-counter bottom"> {92 - content.length}  </div> : null} */}
      </div>
      <div>
