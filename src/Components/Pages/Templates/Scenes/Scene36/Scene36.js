...
const SceneThirtySix = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-20 scene-16 scene-36  scene-17 slider-section">
      ...
      {/* {textShow ? <div class="char-counter"> {122 - content.length}  </div> : null} */}
      {textShow && content.length >= 102 ? <div class={content.length >= 122 ? "char-counter  red" : "char-counter "}>  {122 - content.length} </div> : null}
    </section>
  );
};
