...
const SceneFiftyFour = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-4 slider-section scene-54">
      {showSlider ? (
        <div className="d-flex">
          <div className="img-section d-flex">
            ...
            <div className="left-width-scene">
              <div className="logo-section"><img src={home} alt="home-icons"/></div>
