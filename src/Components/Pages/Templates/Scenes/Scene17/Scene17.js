...
const SceneSevenTeen = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1  scene-16 scene-17 slider-section">
                  ...
                  return index == 1 ? (
                    <div key={index}>
                      <div className="slider-box">
                        ...
                        >
                          {imgindex == index ? (
                            <div className="editbox left-scene">
                              <div className="buttonsection_zoom d-flex">
                                <div
                                  className="scale"
                                  onClick={() => setzoomToggle()}
      ...
      {/* {textShow ? <div class="char-counter"> {100 - content.length}  </div> : null} */}
      {textShow && content.length >= 80 ? <div class={content.length >= 100 ? "char-counter  red" : "char-counter "}>  {100 - content.length} </div> : null}
    </section>
  );
};
