...
const SceneFourteen = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section bottom section-five section-six section-14">
      ...
      {/* {textShow ? <div class="char-counter">52 / {52 - content.length}  </div> : null} */}
      {textShow && content.length >= 32 ? <div class={content.length >= 52 ? "char-counter  red" : "char-counter "}>  {52 - content.length} </div> : null}
    </section>
  );
};
