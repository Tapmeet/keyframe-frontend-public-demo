...
const SceneTwentyFour = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-24  scene-16 slider-section">
              ...
              {layout.map((single) => {
                return (
                  <textarea
                    ...
                    className={
                      "child-container form-control border  size-auto here   "+
                      props.setAlignment
                    }
                    onChange={getcontent}
                    value={content}
                  ...
                  return index == 0 ? (
                    <div key={index}>
                      <div className="slider-box">
                        ...
                        >
                          {imgindex == index ? (
                            <div className="editbox topPadding">
      ...
      {textShow && content.length >= 48 ? <div class={content.length >= 68 ? "char-counter  red" : "char-counter "}>  {68 - content.length} </div> : null}
      {/* {textShow ? <div class="char-counter"> {68 - content.length}  </div> : null} */}
    </section>
  );
};
