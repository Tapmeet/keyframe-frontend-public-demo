...
const SceneThirty = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-16 section-five section-six section-18 scene-30 scene-26 scene-19 slider-section bottom up">
      ...
      {textShow && content.length >= 125 ? <div class={content.length >= 145 ? "char-counter  red" : "char-counter "}>  {145 - content.length} </div> : null}
    </section>
  );
};
