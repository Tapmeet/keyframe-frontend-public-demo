    ...
    <section className="template-new-wrapper-scene1 section-3 slider-section">
      ...
      <Loader open={processing} />  <div className="d-flex">
        <div className="img-section">
          ...
          {/* {textShow ? <div class="char-counter"> {78 - content.length}  </div> : null} */}
          {textShow && content.length >= 58 ? <div class={content.length >= 78 ? "char-counter left red" : "char-counter left"}>  {78 - content.length} </div> : null}
