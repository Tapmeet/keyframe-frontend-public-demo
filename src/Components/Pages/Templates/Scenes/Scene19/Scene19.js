...
const SceneNineTeen = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2 scene-16 section-18 scene-19 slider-section">
              ...
              <div className="col-sm-6">
                ...
                >
                  {mediaArray.map((data, index) => {
                    return (
                      <div key={index}>
                        <div className="slider-box-inner cover" style={{
      ...
      {textShow && content.length >= 60 ? <div class={content.length >= 80 ? "char-counter  red" : "char-counter "}>  {80 - content.length} </div> : null}
