...
const SceneTwentyEight = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2 scene-16  scene-28 scene-26 section-18 scene-19 slider-section">
      ...
      {/* {textShow ? <div class="char-counter"> {110 - content.length}  </div> : null} */}
      {textShow && content.length >= 90 ? <div class={content.length >= 110 ? "char-counter  red" : "char-counter "}>  {110 - content.length} </div> : null}
