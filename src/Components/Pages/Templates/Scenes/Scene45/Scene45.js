...
const SceneFourtyFive = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-24  scene-16 scene-45 slider-section">
      ...
      {textShow && content.length >= 108 ? <div class={content.length >= 128 ? "char-counter  red" : "char-counter "}>  {128 - content.length} </div> : null}
    </section>
  );
};
