...
const SceneThirtyFive = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2 scene-16 scene-35 section-18 scene-34 scene-19 section-six scene-32 slider-section">
                    ...
                    <div className="buttonsection_zoom d-flex">
                      ...
                      <div className="scale-edit">
                        <img
                          ...
                          onClick={() => filterBtnClick(mediaArray[1].url, 1)}
                          data-tip=""
                          data-for="edit"
                        />
                        <ReactTooltip
                      ...
                      <div className="scale-ok">
                        <img
                          ...
                          alt="Thumbnail"
                          className="img-fluid trash"
                          onClick={() => showCroppedImage(mediaArray[1].url)}
                          data-tip=""
                          data-for="done"
                        />
                        <ReactTooltip
      ...
      {textShow && content.length >= 62 ? <div class={content.length >= 82 ? "char-counter  red" : "char-counter "}>  {82 - content.length} </div> : null}
      {/* {textShow ? <div class="char-counter"> {82 - content.length}  </div> : null} */}
    </section>
  );
};
