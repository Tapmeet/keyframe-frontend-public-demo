    ...
    <section className="template-new-wrapper-scene1 slider-section  section-6">
      <Loader open={processing} />  <div className="d-flex">
        <div className="img-section">
          ...
          {textShow && content.length >= 128 ? <div class={content.length >= 148 ? "char-counter  red" : "char-counter "}>  {148 - content.length} </div> : null}
