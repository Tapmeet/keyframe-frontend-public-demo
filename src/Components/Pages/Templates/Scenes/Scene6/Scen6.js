...
const SceneSix = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section bottom section-five section-six">
      ...
      {textShow && content.length >= 117 ? <div class={content.length >= 137 ? "char-counter red" : "char-counter"}>  {137 - content.length} </div> : null}
    </section>
  );
};
