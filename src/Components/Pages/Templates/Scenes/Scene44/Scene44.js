...
const SceneFourtyFour = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 bottom up  scene-16 section-five section-six section-18 scene-30 scene-26 scene-44 scene-19 slider-section">
      ...
      {textShow && content.length >= 118 ? <div class={content.length >= 138 ? "char-counter  red" : "char-counter "}>  {138 - content.length} </div> : null}
    </section>
  );
};
