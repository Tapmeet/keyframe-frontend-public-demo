...
const SceneFourtyNine = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 slider-section scene-49 section-five section-six bottom">
              ...
              return (
                <div key={index}>
                  <div className="slider-box">
                    ...
                    >
                      {imgindex == index ? (
                        <div className="editbox right-scene bottom">
      ...
      {textShow && content.length >= 112 ? <div class={content.length >= 132 ? "char-counter  red" : "char-counter "}>  {132 - content.length} </div> : null}
    </section>
  );
};
