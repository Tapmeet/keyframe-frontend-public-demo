...
const SceneSeventy = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-4 slider-section scene-55 scene-58 scene-59 scene-70 scene-65">
      {showSlider ? (
        <div className="d-flex">
          <div className="img-section d-flex">
            {mediaArray.map((data, index) => {
              return index == 0 ? (
                <div className="positionRelative box-size">
                  <div
                    key={index}
                    id={index}
                    onClick={() =>
