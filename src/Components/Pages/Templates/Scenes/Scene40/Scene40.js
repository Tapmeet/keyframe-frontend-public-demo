...
const SceneFourty = (props) => {
  ...
  return (
    <section className="template-new-wrapper-scene1 scene-2 scene-16 scene-40 section-18 scene-19 slider-section">
       <Loader open={processing} /><div className="d-flex relative">
        ...
        {textShow && content.length >= 76 ? <div class={content.length >= 96 ? "char-counter bottom left red" : "char-counter left bottom "}>  {96 - content.length} </div> : null}
        {/* {textShow ? <div class="char-counter bottom"> {96 - content.length}  </div> : null} */}
      </div>
      <div>
