...
import HOC from "./HOC";
const PlayerSceneFourtyOne = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-18 section-22 scene-40 scene-41  scene-2"
              : "playerui-wrapper  slider-section section-18 section-22 scene-2 scene-40 scene-41"
          }
        >
...
export default PlayerSceneFourtyOne;
