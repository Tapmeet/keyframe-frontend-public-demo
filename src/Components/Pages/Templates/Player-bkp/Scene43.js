...
import HOC from "./HOC";
const PlayerSceneFourtyThree= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-43 section-18 scene-2"
              : "playerui-wrapper  slider-section section-18 section-43 scene-2"
          }
        >
...
export default PlayerSceneFourtyThree;
