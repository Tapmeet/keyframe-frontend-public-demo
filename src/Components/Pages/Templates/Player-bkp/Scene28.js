...
import HOC from "./HOC";
const PlayerSceneTwentyEight = (props) => {
  console.log(props);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-16 section-18 scene-19 scene-26 scene-28  "
              : " playerui-wrapper  slider-section scene-2 scene-16 section-18 scene-19 scene-26  scene-28  "
          }
        >
...
export default PlayerSceneTwentyEight;
