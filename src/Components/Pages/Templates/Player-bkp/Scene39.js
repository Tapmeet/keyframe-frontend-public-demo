...
import HOC from "./HOC";
const PlayerSceneThirtyNine= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-18 scene-2 section-39"
              : "playerui-wrapper  slider-section section-18 scene-2 section-39"
          }
        >
...
export default PlayerSceneThirtyNine;
