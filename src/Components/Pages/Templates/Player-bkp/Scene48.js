...
import HOC from "./HOC";
const PlayerSceneFourtyEight= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-13 scene-27 scene-48"
              : "playerui-wrapper  slider-section scene-2 scene-13 scene-27 scene-48"
          }
        >
...
export default PlayerSceneFourtyEight;
