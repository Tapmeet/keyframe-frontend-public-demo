...
import HOC from "./HOC";
const PlayerSceneFourtyNine = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section   section-five section-six scene-49"
              : " playerui-wrapper  slider-section    section-five section-six scene-49"
          }
        >
...
export default PlayerSceneFourtyNine;
