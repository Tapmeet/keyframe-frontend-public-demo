    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section   section-five section-six"
              : " playerui-wrapper  slider-section    section-five section-six"
          }
        >
