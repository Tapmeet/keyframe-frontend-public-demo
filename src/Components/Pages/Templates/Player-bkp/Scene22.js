...
import HOC from "./HOC";
const PlayerSceneTwentyTwo= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section section-18 section-22  scene-2"
              : "playerui-wrapper  slider-section section-18 section-22 scene-2"
          }
        >
...
export default PlayerSceneTwentyTwo;
