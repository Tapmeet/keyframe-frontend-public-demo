...
import HOC from "./HOC";
const PlayerSceneThirtyOne= (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-16 scene-31"
              : " playerui-wrapper  slider-section scene-16 scene-31 "
          }
        >
...
export default PlayerSceneThirtyOne;
