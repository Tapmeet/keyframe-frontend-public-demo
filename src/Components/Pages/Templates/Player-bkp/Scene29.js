...
import HOC from "./HOC";
const PlayerSceneTwentyNine = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section   section-six section-29"
              : " playerui-wrapper  slider-section    section-six section-29"
          }
        >
...
export default PlayerSceneTwentyNine;
