...
import HOC from "./HOC";
const PlayerSceneFourtySix = (props) => {
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-20 scene-16  scene-46 scene-17 scene-36 "
              : " playerui-wrapper  slider-section scene-20 scene-16 scene-46 scene-17 scene-36  "
          }
        >
...
export default PlayerSceneFourtySix;
