...
import HOC from "./HOC";
const PlayerSceneThirtyEight = (props) => {
  console.log(props);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-16 scene-21  scene-38 "
              : " playerui-wrapper  slider-section scene-2 scene-16   scene-21  scene-38"
          }
        >
...
export default PlayerSceneThirtyEight;
