...
import HOC from "./HOC";
const PlayerSceneFourtyFour = (props) => {
  console.log(props);
    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-16 scene-44 section-18 scene-19 scene-26 scene-30  "
              : " playerui-wrapper  slider-section scene-2 scene-16 scene-44 section-18 scene-19 scene-26  scene-30  "
          }
        >
...
export default PlayerSceneFourtyFour;
