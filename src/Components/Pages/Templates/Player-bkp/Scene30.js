    ...
    <HOC>
      {sceneActive ? (
        <section
          className={
            activeClass
              ? " playerui-wrapper active slider-section scene-2 scene-16 section-18 scene-19 scene-26 scene-30  "
              : " playerui-wrapper  slider-section scene-2 scene-16 section-18 scene-19 scene-26  scene-30  "
          }
        >
            ...
            <div className="img-section d-flex justify-content-between">
              <div className="bg-section d-flex justify-end">
                <div className="full-width d-flex">
                  <div
                    alt="imgmain"
                    className="imgone img-slide"style={{
...
export default PlayerSceneThirty;
