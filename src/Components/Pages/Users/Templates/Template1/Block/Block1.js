            ...
            <div className="edit-block-wrapper d-flex">
                            ...
                            <div className={buttonCheck ? ' img-section-bottom' : "show img-section-bottom"}>
                                ...
                                {checkBlockTitle ?
                                    <div className="text-wrapper">
                                        ...
                                        <div className="subtitle" style={{ color: subtitleColor, 'fontSize': blocksubTitleFontsize + 'px', 'fontFamily': globalFont }}>
                                            {blocksubTitle}
                                        </div>
                                    </div>
                                    : null}
                ...
                <div className="pane-wrapper">
                    <div className="enter-text">
                        ...
                        <input type="text" placeholder="Subtitle" value={blocksubTitle} onChange={e => setBlocksubTitle(e.currentTarget.value)} className="form-control title subtitle" />
                    </div>
