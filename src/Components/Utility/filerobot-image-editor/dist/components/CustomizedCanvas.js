  ...
  _createClass(CustomizedCanvas, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          parentCanvasHeight = _this$props3.height,
          parentCanvasWidth = _this$props3.width,
          _this$props3$selected = _this$props3.selectedShape,
          _this$props3$selected2 = _this$props3$selected.width,
          width = _this$props3$selected2 === void 0 ? 0 : _this$props3$selected2,
          _this$props3$selected3 = _this$props3$selected.height,
          height = _this$props3$selected3 === void 0 ? 0 : _this$props3$selected3,
          _this$props3$selected4 = _this$props3$selected.x,
          x = _this$props3$selected4 === void 0 ? 0 : _this$props3$selected4,
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(CustomizedCanvas, "CustomizedCanvas", "/Users/dmitrystremous/Scaleflex/plugins/filerobot-image-editor/projects/react/components/CustomizedCanvas.js");
}();
